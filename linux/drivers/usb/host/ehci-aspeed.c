...
// Vadim generic?
#if 0
static const struct ehci_driver_overrides ehci_ast_overrides __initdata = {
	.extra_priv_size = sizeof(struct ehci_hcd), // Vadim
};
#endif
...
static int ehci_hcd_ast_drv_resume(struct platform_device *pdev)
{
	...
	ehci_port_power(ehci, 1, 1); /* Vadim */
...
static int __init ehci_ast_init(void)
{
	...
	ehci_init_driver(&ehci_hcd_ast_driver, &ehci_ast_overrides);
