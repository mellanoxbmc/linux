...
#define J20 12
GPIO_PIN_DECL(J20, GPIOB4);

#define H21 13
GPIO_PIN_DECL(H21, GPIOB5);

#define H22 14
SIG_EXPR_LIST_DECL_SINGLE(GPIOB6, GPIOB6, SIG_DESC_BIT(SCU80, 14, 0));
SIG_EXPR_LIST_DECL_SINGLE(LPCPME, LPCPME, SIG_DESC_SET(SCU80, 14));
MS_PIN_DECL_(H22, SIG_EXPR_LIST_PTR(GPIOB6), SIG_EXPR_LIST_PTR(LPCPME));
...
MS_PIN_DECL(F20, GPIOD3, SD2DAT0, GPID2IN);
...
MS_PIN_DECL(D20, GPIOD4, SD2DAT1, GPID2OUT);

FUNC_GROUP_DECL(GPID2, F20, D20);

#define D21 28
GPIO_PIN_DECL(D21, GPIOD2);

#define GPIE_DESC	SIG_DESC_SET(HW_STRAP1, 21)
#define GPIE0_DESC	SIG_DESC_SET(SCU8C, 12)

#define E20 29
GPIO_PIN_DECL(E20, GPIOD5);

#define G18 30
GPIO_PIN_DECL(G18, GPIOD6);

#define C21 31
GPIO_PIN_DECL(C21, GPIOD7);
...
#define F18 34
GPIO_PIN_DECL(F18, GPIOE2);

#define F17 35
GPIO_PIN_DECL(F17, GPIOE3);

#define E18 36
GPIO_PIN_DECL(E18, GPIOE4);

#define D19 37
GPIO_PIN_DECL(D19, GPIOE5);

#define A20 38
GPIO_PIN_DECL(A20, GPIOE6);

#define B19 39
GPIO_PIN_DECL(B19, GPIOE7);

#define J19 40
GPIO_PIN_DECL(J19, GPIOF0);

#define J18 41
GPIO_PIN_DECL(J18, GPIOF1);

#define B22 42
GPIO_PIN_DECL(B22, GPIOF2);

#define B21 43
GPIO_PIN_DECL(B21, GPIOF3);

#define A21 44
GPIO_PIN_DECL(A21, GPIOF4);

#define H19 45
GPIO_PIN_DECL(H19, GPIOF5);

#define G17 46
GPIO_PIN_DECL(G17, GPIOF6);

#define H18 47
GPIO_PIN_DECL(H18, GPIOF7);

#define A19 48
GPIO_PIN_DECL(A19, GPIOG0);

#define E19 49
GPIO_PIN_DECL(E19, GPIOG1);

#define C19 50
GPIO_PIN_DECL(C19, GPIOG2);

#define E16 51
GPIO_PIN_DECL(E16, GPIOG3);

#define E17 52
GPIO_PIN_DECL(E17, GPIOG4);

#define D16 53
GPIO_PIN_DECL(D16, GPIOG5);

#define D15 54
GPIO_PIN_DECL(D15, GPIOG6);

#define E14 55
GPIO_PIN_DECL(E14, GPIOG7);

#define A18 56
GPIO_PIN_DECL(A18, GPIOH0);

#define B18 57
GPIO_PIN_DECL(B18, GPIOH1);

#define D17 58
GPIO_PIN_DECL(D17, GPIOH2);

#define C17 59
GPIO_PIN_DECL(C17, GPIOH3);

#define A17 60
GPIO_PIN_DECL(A17, GPIOH4);

#define B17 61
GPIO_PIN_DECL(B17, GPIOH5);

#define A16 62
GPIO_PIN_DECL(A16, GPIOH6);

#define D18 63
GPIO_PIN_DECL(D18, GPIOH7);
...
#define N5 76
GPIO_PIN_DECL(N5, GPIOJ4);

#define R4 77
GPIO_PIN_DECL(R4, GPIOJ5);

#define R3 78
GPIO_PIN_DECL(R3, GPIOJ6);

#define T3 79
GPIO_PIN_DECL(T3, GPIOJ7);
...
SIG_EXPR_DECL(VPIDE, VPI18, VPI18_DESC, T1_DESC);
SIG_EXPR_DECL(VPIDE, VPI24, VPI24_DESC, T1_DESC);
SIG_EXPR_DECL(VPIDE, VPI30, VPI30_DESC, T1_DESC);
SIG_EXPR_LIST_DECL(VPIDE, SIG_EXPR_PTR(VPIDE, VPI18),
		   SIG_EXPR_PTR(VPIDE, VPI24), SIG_EXPR_PTR(VPIDE, VPI30));
...
SIG_EXPR_DECL(VPIODD, VPI18, VPI18_DESC, U1_DESC);
SIG_EXPR_DECL(VPIODD, VPI24, VPI24_DESC, U1_DESC);
SIG_EXPR_DECL(VPIODD, VPI30, VPI30_DESC, U1_DESC);
SIG_EXPR_LIST_DECL(VPIODD, SIG_EXPR_PTR(VPIODD, VPI18),
		   SIG_EXPR_PTR(VPIODD, VPI24),	SIG_EXPR_PTR(VPIODD, VPI30));
SIG_EXPR_LIST_DECL_SINGLE(NDSR1, NDSR1, U1_DESC);
MS_PIN_DECL(U1, GPIOL2, VPIODD, NDSR1);
FUNC_GROUP_DECL(NDSR1, U1);

/*NRI1 U2*/
#define U2 91
#define U2_DESC         SIG_DESC_SET(SCU84, 19)
SIG_EXPR_DECL(VPIHS, VPI18, VPI18_DESC, U2_DESC);
SIG_EXPR_DECL(VPIHS, VPI24, VPI24_DESC, U2_DESC);
SIG_EXPR_DECL(VPIHS, VPI30, VPI30_DESC, U2_DESC);
SIG_EXPR_LIST_DECL(VPIHS, SIG_EXPR_PTR(VPIHS, VPI18),
		   SIG_EXPR_PTR(VPIHS, VPI24), SIG_EXPR_PTR(VPIHS, VPI30));
...
SIG_EXPR_DECL(VPIVS, VPI18, VPI18_DESC, P4_DESC);
SIG_EXPR_DECL(VPIVS, VPI24, VPI24_DESC, P4_DESC);
SIG_EXPR_DECL(VPIVS, VPI30, VPI30_DESC, P4_DESC);
SIG_EXPR_LIST_DECL(VPIVS, SIG_EXPR_PTR(VPIVS, VPI18),
		   SIG_EXPR_PTR(VPIVS, VPI24), SIG_EXPR_PTR(VPIVS, VPI30));
...
SIG_EXPR_DECL(VPICLK, VPI18, VPI18_DESC, P3_DESC);
SIG_EXPR_DECL(VPICLK, VPI24, VPI24_DESC, P3_DESC);
SIG_EXPR_DECL(VPICLK, VPI30, VPI30_DESC, P3_DESC);
SIG_EXPR_LIST_DECL(VPICLK, SIG_EXPR_PTR(VPICLK, VPI18),
		   SIG_EXPR_PTR(VPICLK, VPI24), SIG_EXPR_PTR(VPICLK, VPI30));
...
SIG_EXPR_LIST_DECL_SINGLE(VPIB0, VPI30, VPI30_DESC, V1_DESC);
SIG_EXPR_LIST_DECL_SINGLE(TXD1, TXD1, V1_DESC, COND2);
MS_PIN_DECL(V1, GPIOL6, VPIB0, TXD1);
FUNC_GROUP_DECL(TXD1, V1);

/*RXD1 W1*/
#define W1 95
#define W1_DESC         SIG_DESC_SET(SCU84, 23)
SIG_EXPR_LIST_DECL_SINGLE(VPIB1, VPI30, VPI30_DESC, W1_DESC);
SIG_EXPR_LIST_DECL_SINGLE(RXD1, RXD1, W1_DESC, COND2);
MS_PIN_DECL(W1, GPIOL7, VPIB1, RXD1);
FUNC_GROUP_DECL(RXD1, W1);

#define Y1 96
GPIO_PIN_DECL(Y1, GPIOM0);

#define AB2 97
GPIO_PIN_DECL(AB2, GPIOM1);

#define AA1 98
GPIO_PIN_DECL(AA1, GPIOM2);

#define Y2 99
GPIO_PIN_DECL(Y2, GPIOM3);

#define AA2 100
GPIO_PIN_DECL(AA2, GPIOM4);

#define P5 101
GPIO_PIN_DECL(P5, GPIOM5);

#define R5 102
GPIO_PIN_DECL(R5, GPIOM6);

#define T5 103
GPIO_PIN_DECL(T5, GPIOM7);
...
#define U5 112
GPIO_PIN_DECL(U5, GPIOO0);

#define U4 113
GPIO_PIN_DECL(U4, GPIOO1);

#define V5 114
GPIO_PIN_DECL(V5, GPIOO2);

#define AB4 115
GPIO_PIN_DECL(AB4, GPIOO3);

#define AB3 116
GPIO_PIN_DECL(AB3, GPIOO4);

#define Y4 117
GPIO_PIN_DECL(Y4, GPIOO5);

#define AA4 118
GPIO_PIN_DECL(AA4, GPIOO6);

#define W4 119
GPIO_PIN_DECL(W4, GPIOO7);

#define V4 120
GPIO_PIN_DECL(V4, GPIOP0);

#define W5 121
GPIO_PIN_DECL(W5, GPIOP1);

#define AA5 122
GPIO_PIN_DECL(AA5, GPIOP2);

#define AB5 123
GPIO_PIN_DECL(AB5, GPIOP3);

#define Y6 124
GPIO_PIN_DECL(Y6, GPIOP4);

#define Y5 125
GPIO_PIN_DECL(Y5, GPIOP5);

#define W6 126
GPIO_PIN_DECL(W6, GPIOP6);
...
#define R18 146
GPIO_PIN_DECL(R18, GPIOS2);

#define P18 147
GPIO_PIN_DECL(P18, GPIOS3);

#define R19 148
GPIO_PIN_DECL(R19, GPIOS4);

#define W20 149
GPIO_PIN_DECL(W20, GPIOS5);

#define U20 150
GPIO_PIN_DECL(U20, GPIOS6);

#define AA20 151
GPIO_PIN_DECL(AA20, GPIOS7);
...
#define F4 176
GPIO_PIN_DECL(F4, GPIOW0);

#define F5 177
GPIO_PIN_DECL(F5, GPIOW1);

#define E2 178
GPIO_PIN_DECL(E2, GPIOW2);

#define E1 179
GPIO_PIN_DECL(E1, GPIOW3);

#define F3 180
GPIO_PIN_DECL(F3, GPIOW4);

#define E3 181
GPIO_PIN_DECL(E3, GPIOW5);

#define G5 182
GPIO_PIN_DECL(G5, GPIOW6);

#define G4 183
GPIO_PIN_DECL(G4, GPIOW7);

#define F2 184
GPIO_PIN_DECL(F2, GPIOX0);

#define G3 185
GPIO_PIN_DECL(G3, GPIOX1);

#define G2 186
GPIO_PIN_DECL(G2, GPIOX2);

#define F1 187
GPIO_PIN_DECL(F1, GPIOX3);

#define H5 188
GPIO_PIN_DECL(H5, GPIOX4);

#define G1 189
GPIO_PIN_DECL(G1, GPIOX5);

#define H3 190
GPIO_PIN_DECL(H3, GPIOX6);

#define H4 191
GPIO_PIN_DECL(H4, GPIOX7);

#define R22 192
GPIO_PIN_DECL(R22, GPIOY0);

#define R21 193
GPIO_PIN_DECL(R21, GPIOY1);

#define P22 194
GPIO_PIN_DECL(P22, GPIOY2);

#define P21 195
GPIO_PIN_DECL(P21, GPIOY3);

#define M18 196
GPIO_PIN_DECL(M18, GPIOY4);

#define M19 197
GPIO_PIN_DECL(M19, GPIOY5);

#define M20 198
GPIO_PIN_DECL(M20, GPIOY6);

#define P20 199
GPIO_PIN_DECL(P20, GPIOY7);

#define Y20 200
GPIO_PIN_DECL(Y20, GPIOZ0);

#define AB20 201
GPIO_PIN_DECL(AB20, GPIOZ1);

#define AB21 202
GPIO_PIN_DECL(AB21, GPIOZ2);

#define AA21 203
GPIO_PIN_DECL(AA21, GPIOZ3);

#define U21 204
GPIO_PIN_DECL(U21, GPIOZ4);

#define W22 205
GPIO_PIN_DECL(W22, GPIOZ5);

#define V22 206
GPIO_PIN_DECL(V22, GPIOZ6);

#define W21 207
GPIO_PIN_DECL(W21, GPIOZ7);

#define Y21 208
GPIO_PIN_DECL(Y21, GPIOAA0);

#define V21 209
GPIO_PIN_DECL(V21, GPIOAA1);

#define Y22 210
GPIO_PIN_DECL(Y22, GPIOAA2);

#define AA22 211
GPIO_PIN_DECL(AA22, GPIOAA3);

#define U22 212
GPIO_PIN_DECL(U22, GPIOAA4);

#define T20 213
GPIO_PIN_DECL(T20, GPIOAA5);

#define N18 214
GPIO_PIN_DECL(N18, GPIOAA6);

#define P19 215
GPIO_PIN_DECL(P19, GPIOAA7);

#define N19 216
GPIO_PIN_DECL(N19, GPIOAB0);

#define T21 217
GPIO_PIN_DECL(T21, GPIOAB1);

#define T22 218
GPIO_PIN_DECL(T22, GPIOAB2);

#define R20 219
GPIO_PIN_DECL(R20, GPIOAB3);

#define G21 220
SIG_EXPR_LIST_DECL_SINGLE(GPIOAC0, GPIOAC0, SIG_DESC_BIT(HW_STRAP1, 25, 0),
	SIG_DESC_BIT(SCUAC, 0, 0));
SIG_EXPR_LIST_DECL_SINGLE(ESPID0, ESPID0, SIG_DESC_SET(HW_STRAP1, 25));
SIG_EXPR_LIST_DECL_SINGLE(LAD0, LAD0, SIG_DESC_BIT(HW_STRAP1, 25, 0),
	SIG_DESC_SET(SCUAC, 0));
MS_PIN_DECL_(G21, SIG_EXPR_LIST_PTR(GPIOAC0), SIG_EXPR_LIST_PTR(ESPID0),
		SIG_EXPR_LIST_PTR(LAD0));

#define G20 221
SIG_EXPR_LIST_DECL_SINGLE(GPIOAC1, GPIOAC1, SIG_DESC_BIT(HW_STRAP1, 25, 0),
	SIG_DESC_BIT(SCUAC, 1, 0));
SIG_EXPR_LIST_DECL_SINGLE(ESPID1, ESPID1, SIG_DESC_SET(HW_STRAP1, 25));
SIG_EXPR_LIST_DECL_SINGLE(LAD1, LAD1, SIG_DESC_BIT(HW_STRAP1, 25, 0),
	SIG_DESC_SET(SCUAC, 1));
MS_PIN_DECL_(G20, SIG_EXPR_LIST_PTR(GPIOAC1), SIG_EXPR_LIST_PTR(ESPID1),
		SIG_EXPR_LIST_PTR(LAD1));

#define D22 222
SIG_EXPR_LIST_DECL_SINGLE(GPIOAC2, GPIOAC2, SIG_DESC_BIT(HW_STRAP1, 25, 0),
	SIG_DESC_BIT(SCUAC, 2, 0));
SIG_EXPR_LIST_DECL_SINGLE(ESPID2, ESPID2, SIG_DESC_SET(HW_STRAP1, 25));
SIG_EXPR_LIST_DECL_SINGLE(LAD2, LAD2, SIG_DESC_BIT(HW_STRAP1, 25, 0),
	SIG_DESC_SET(SCUAC, 2));
MS_PIN_DECL_(D22, SIG_EXPR_LIST_PTR(GPIOAC2), SIG_EXPR_LIST_PTR(ESPID2),
		SIG_EXPR_LIST_PTR(LAD2));

#define E22 223
SIG_EXPR_LIST_DECL_SINGLE(GPIOAC3, GPIOAC3, SIG_DESC_BIT(HW_STRAP1, 25, 0),
	SIG_DESC_BIT(SCUAC, 3, 0));
SIG_EXPR_LIST_DECL_SINGLE(ESPID3, ESPID3, SIG_DESC_SET(HW_STRAP1, 25));
SIG_EXPR_LIST_DECL_SINGLE(LAD3, LAD3, SIG_DESC_BIT(HW_STRAP1, 25, 0),
	SIG_DESC_SET(SCUAC, 3));
MS_PIN_DECL_(E22, SIG_EXPR_LIST_PTR(GPIOAC3), SIG_EXPR_LIST_PTR(ESPID3),
		SIG_EXPR_LIST_PTR(LAD3));

#define C22 224
SIG_EXPR_LIST_DECL_SINGLE(GPIOAC4, GPIOAC4, SIG_DESC_BIT(HW_STRAP1, 25, 0),
	 SIG_DESC_BIT(SCUAC, 4, 0));
SIG_EXPR_LIST_DECL_SINGLE(ESPICK, ESPICK, SIG_DESC_SET(HW_STRAP1, 25));
SIG_EXPR_LIST_DECL_SINGLE(LCLK, LCLK, SIG_DESC_BIT(HW_STRAP1, 25, 0),
	SIG_DESC_SET(SCUAC, 4));
MS_PIN_DECL_(C22, SIG_EXPR_LIST_PTR(GPIOAC4), SIG_EXPR_LIST_PTR(ESPICK),
		SIG_EXPR_LIST_PTR(LCLK));

#define F21 225
SIG_EXPR_LIST_DECL_SINGLE(GPIOAC5, GPIOAC5, SIG_DESC_BIT(HW_STRAP1, 25, 0),
	SIG_DESC_BIT(SCUAC, 5, 0));
SIG_EXPR_LIST_DECL_SINGLE(ESPICS, ESPICS, SIG_DESC_SET(HW_STRAP1, 25));
SIG_EXPR_LIST_DECL_SINGLE(LFRAME, LFRAME, SIG_DESC_BIT(HW_STRAP1, 25, 0),
SIG_DESC_SET(SCUAC, 5));
MS_PIN_DECL_(F21, SIG_EXPR_LIST_PTR(GPIOAC5), SIG_EXPR_LIST_PTR(ESPICS),
		SIG_EXPR_LIST_PTR(LFRAME));

#define F22 226
SIG_EXPR_LIST_DECL_SINGLE(GPIOAC6, GPIOAC6, SIG_DESC_BIT(HW_STRAP1, 25, 0),
	SIG_DESC_BIT(SCUAC, 6, 0));
SIG_EXPR_LIST_DECL_SINGLE(ESPIALT, ESPIALTL, SIG_DESC_SET(HW_STRAP1, 25));
SIG_EXPR_LIST_DECL_SINGLE(LSIRQ, LSIRQL, SIG_DESC_BIT(HW_STRAP1, 25, 0),
	SIG_DESC_SET(SCUAC, 6));
MS_PIN_DECL_(F22, SIG_EXPR_LIST_PTR(GPIOAC6), SIG_EXPR_LIST_PTR(ESPIALT),
		SIG_EXPR_LIST_PTR(LSIRQ));

#define G22 227
SIG_EXPR_LIST_DECL_SINGLE(GPIOAC7, GPIOAC7, SIG_DESC_BIT(HW_STRAP1, 25, 0),
	SIG_DESC_BIT(SCUAC, 7, 0));
SIG_EXPR_LIST_DECL_SINGLE(ESPIRST, ESPIRST, SIG_DESC_SET(HW_STRAP1, 25));
SIG_EXPR_LIST_DECL_SINGLE(LPCRST, LPCRST, SIG_DESC_BIT(HW_STRAP1, 25, 0),
	SIG_DESC_SET(SCUAC, 7));
MS_PIN_DECL_(G22, SIG_EXPR_LIST_PTR(GPIOAC7), SIG_EXPR_LIST_PTR(ESPIRST),
		SIG_EXPR_LIST_PTR(LPCRST));

FUNC_GROUP_DECL(LPC, G21, G20, D22, E22, C22, F21, F22, G22, H22);
